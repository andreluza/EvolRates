...
#load packages and transition rates 7function

source("R/packages.R")
source("R/transition_rates_function.R")

# 1 - Load the phylogenetic trees
...
## species not included in the previous categories treated as 'generalists'
...
# you must apply nsim to one phylogeny each time. 
# Thus, the list argument contains the phylogenies as class multiphlylo
...
saveRDS (transitions_estimates_ages, 
         here ("Output",
               "res_step1_transitions_estimates_ages.rda"))
